...
void main() {
  ...
  group("Fixed Matcher", () {
    test("Case 1 - fixed match", () {
      ...
      var uri = Uri.parse("https://myapi.com/this/is/a/path?my=parameter&another=1");
      expect(matcher.match(uri).result, true);
    });
    test("Case 2 - invalid length", () {
      var matcher = PathUtils.parseMatcher("this/is/a/path");
      var uri = Uri.parse("https://myapi.com/this/is/path?my=parameter&another=1");
  ...
  group("Variable Matcher", () {
    test("Case 1 - basic", () {
      ...
      var uri = Uri.parse("https://myapi.com/this/is/a/value?my=parameter&another=1");
