...
void main() {
  test("Resolution order", () async {
    ...
    var b = ServiceDescriptor.create(B, (p0) => null, optionalDependencies: [InjectorKey.create(A)]);
  ...
  test("Optional service", () async {
    var a = ServiceDescriptor.create(A, (p0) => null);
    var b = ServiceDescriptor.create(B, (p0) => null, dependencies: [InjectorKey.create(Z)], optional: true);
    var c = ServiceDescriptor.create(C, (p0) => null,
  ...
  test("Missing dependency", () async {
    var a = ServiceDescriptor.create(A, (p0) => null);
    var b = ServiceDescriptor.create(B, (p0) => null, dependencies: [InjectorKey.create(B)]);
    var c = ServiceDescriptor.create(C, (p0) => null,
  ...
  test("Missing optional dependency", () async {
    var a = ServiceDescriptor.create(A, (p0) => null);
    var b = ServiceDescriptor.create(B, (p0) => null, dependencies: [InjectorKey.create(A)]);
    var c = ServiceDescriptor.create(C, (p0) => null,
